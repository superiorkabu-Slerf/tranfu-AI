      ...
      <div className="max-w-[1120px] mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="flex items-center gap-6">
          ...
          <div className="hidden md:flex items-center gap-4 border-l border-border-subtle pl-6">
            <Link to="/products" className="text-[12px] mono-label text-tx-tertiary hover:text-tx-primary transition-colors">产品</Link>
            <Link to="/resources" className="text-[12px] mono-label text-tx-tertiary hover:text-tx-primary transition-colors">资源</Link>
            <Link to="/lab" className="text-[12px] mono-label text-tx-tertiary hover:text-tx-primary transition-colors">实验室</Link>
          </div>
        </div>

        <div className="flex items-center gap-6 text-[11px] mono-label text-tx-quaternary uppercase tracking-widest">
          <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
            <span>© 2024 TRANFU 产品实践站</span>
          ...
          <Link to="/about" className="hover:text-tx-secondary transition-colors underline-offset-4 underline decoration-transparent hover:decoration-tx-quaternary">关于我们</Link>
        </div>
      </div>
    </footer>
  );
